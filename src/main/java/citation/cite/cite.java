...
public class cite extends JPanel {
    ...
    private void components(){
        ...
        JLabel startCiting = new JLabel("Start citing information from CNN, Fox News, The New York Times, BBC,");

        // printing the rest on a second line
        JLabel startCitingLineTwo = new JLabel("and Wall Street Journal!");
        ...
        String websites[] = {"CNN", "Fox News", "The New York Times", "BBC", "Wall Street Journal" };
